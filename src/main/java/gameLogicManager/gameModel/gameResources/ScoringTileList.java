...
public class ScoringTileList {
    ...
    public static ScoringTile[] scoringTileInitializer(){
        ...
        scoringTiles[0] = new ScoringTile(0);// Dwelling+2 / 4 Water = Priest
        scoringTiles[1] = new ScoringTile(1);// Stronghold/Sanctuary+5 / 2 Fire = Worker
        scoringTiles[2] = new ScoringTile(2);// Dwelling+2 / 4 Fire = 4 Power
